...
The main operational lesson from this setup was that the agent needed stronger boundaries around troubleshooting and authentication.
...
The agent must never represent:
...
as professional employment experience.
...
The guardrails make troubleshooting safer and more reproducible by separating:
